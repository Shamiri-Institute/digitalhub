-- Add session names for Lifeskills Intervention (single hub)
-- Target hub: 26P2_Hub_07 (by visible_id)
...
FROM (
    ...
    UNION ALL
    SELECT 'INTERVENTION', 's5', 'Session 5', 1500
    UNION ALL
    SELECT 'INTERVENTION', 's6', 'Session 6', 1500
    UNION ALL
    SELECT 'INTERVENTION', 's7', 'Session 7', 1500
    UNION ALL
    SELECT 'INTERVENTION', 's8', 'Session 8', 1500
    UNION ALL
