...
let comments = [
  {
    ...
    date: "22/08/2023",
    comment:
      "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe ex, voluptates quos dolor quae vero repellat tempora! Rem, officiis cumque. Dignissimos voluptas suscipit dolor vitae animi corporis iste iusto molestiae.",
  },
  {
    id: 2,
...
const CommentsDialogue = ({ children }: { children: React.ReactNode }) => {
  return (
    <Dialog>
      ...
      <DialogContent className="gap-0 p-0">
        <DialogHeader className="space-y-0 px-6 py-4">
          <div className="flex items-center gap-2">
            <span className="text-base font-medium">5 Comments</span>
          </div>
        </DialogHeader>
