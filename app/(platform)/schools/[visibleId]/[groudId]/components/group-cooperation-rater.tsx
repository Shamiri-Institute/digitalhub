...
export function GroupDisciplineRater({
  ...
  const onRatingSelect = React.useCallback(
    async (key: "c1" | "c2" | "c3" | "cComment", rating: number | string) => {
          ...
          <AccordionContent>
            <div className="pt-4">
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <RatingStars
                  onSelect={(rating) => {
                    onRatingSelect("c1", rating);
                  }}
                  rating={ratings ? ratings.c1! : 0}
                />
              </div>
              <div className="mt-4 flex items-center justify-between">
                <p className="text-sm font-normal text-brand">
                ...
                <RatingStars
                  onSelect={(rating) => {
                    onRatingSelect("c2", rating);
                  }}
                  rating={ratings ? ratings.c2! : 0}
                />
              </div>
              <div className="mt-4 flex items-center justify-between">
                <p className="text-sm font-normal text-brand">
                ...
                <RatingStars
                  onSelect={(rating) => {
                    onRatingSelect("c3", rating);
                  }}
                  rating={ratings ? ratings.c3! : 0}
                />
              </div>
...
function WrittenEvaluation({
  ...
  const handlSubmitComments = () => {
    onRatingSelect("cComment", comments);
  };
  ...
  return (
    <div className="px-1">
      ...
      <Button
        ...
        disabled={comments.length === 0 || comments === ratings?.cComment}
      >
        Save Evaluation
      </Button>
    </div>
