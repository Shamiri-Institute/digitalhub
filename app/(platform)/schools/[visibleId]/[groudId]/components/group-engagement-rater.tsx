...
export function GroupEngagementRater({
  ...
  const onRatingSelect = React.useCallback(
    async (key: "e1" | "e2" | "e3" | "eComment", rating: number | string) => {
          ...
          <AccordionContent>
            <div className="pt-4">
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <RatingStars
                  onSelect={(rating) => {
                    onRatingSelect("e1", rating);
                  }}
                  rating={ratings ? ratings.e1! : 0}
                />
              </div>
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <RatingStars
                  onSelect={(rating) => {
                    onRatingSelect("e2", rating);
                  }}
                  rating={ratings ? ratings.e2! : 0}
                />
              </div>
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <RatingStars
                  onSelect={(rating) => {
                    onRatingSelect("e3", rating);
                  }}
                  rating={ratings ? ratings.e3! : 0}
                />
              </div>
              <WrittenEvaluation
...
function WrittenEvaluation({
  ...
  const handlSubmitComments = () => {
    onRatingSelect("eComment", comments);
  };
  ...
  return (
    <div className="px-1">
      ...
      <Button
        ...
        disabled={comments.length === 0 || comments === ratings?.eComment}
      >
        Save Evaluation
      </Button>
    </div>
