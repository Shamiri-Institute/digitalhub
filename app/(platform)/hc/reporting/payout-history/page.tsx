import { loadHubPayoutHistory } from "#/app/(platform)/hc/reporting/payout-history/actions";
import HCPayoutHistoryDataTable from "#/app/(platform)/hc/reporting/payout-history/components/payout-history-table";
