...
export function ReimbursementRequests({
  ...
  requests: Prisma.ReimbursementRequestGetPayload<{}>[];
}) {
      ...
      <div className="mr-4 flex flex-1 flex-col ">
        <div className="flex justify-between">
          <div className="flex gap-1.5">
            <p className="text-base font-normal uppercase text-brand">
              {(request.details as any)["subtype"]}
            </p>
            <span
              className={cn(
                "inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium capitalize ring-1 ring-inset",
                {
        ...
        <div className="flex justify-between">
          <p className="text-xs font-normal text-muted-foreground">
            {" "}
            {format(request.incurredAt, "MMMM dd")}
          </p>
          <p className="text-xs font-normal text-muted-foreground">
            {request.mpesaNumber}
          </p>
