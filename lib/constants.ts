...
export const CURRENT_PROJECT_ID = validate(
  process.env.NEXT_PUBLIC_CURRENT_PROJECT_ID,
  "NEXT_PUBLIC_CURRENT_PROJECT_ID",
);
...
export const ACTIVE_PROJECT_ID_COOKIE = "active-project-id";
