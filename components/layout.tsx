...
export function Layout({children}: { children: React.ReactNode }) {
    ...
    return (
        <div className="h-full max-w-7xl lg:ml-72 xl:ml-80">
            ...
            >
                <div
                    className="contents lg:pointer-events-auto lg:block lg:w-72 lg:overflow-y-auto lg:border-r lg:border-border lg:px-6 lg:pb-8 lg:pt-4 xl:w-80">
        ...
        <>
            <header className="bg-background-secondary border-b">
                <div className="container pt-2 space-y-4">
                    ...
                    <div className="no-scrollbar flex gap-8 items-center overflow-x-auto px-2">
