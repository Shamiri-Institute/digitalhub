...
export function SessionDropDown({
  ...
  state: {
    ...
    setStudentAttendanceFilesDialog?: Dispatch<SetStateAction<boolean>>;
  };
  role: ImplementerRole;
  fellowId?: string;
  supervisorId?: string;
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align={"end"}>
        ...
        {role === ImplementerRole.ADMIN && (
          <>
            {isSchedulePage && session.session?.sessionType === "INTERVENTION" && (
        ...
        {role === ImplementerRole.FELLOW ? (
          <>
            ...
            <DropdownMenuItem
              onClick={() => {
                state.setSession?.(session);
                state.setStudentAttendanceFilesDialog?.(true);
              }}
              disabled={
                session.status === "Cancelled" ||
                !session.occurred ||
            ...
            >
              View student attendance documents
            </DropdownMenuItem>
          </>
        ) : null}
      </DropdownMenuContent>
