...
rm -rf $B/out/crawl-before $B/out/crawl-after $B/out/forms-before $B/out/forms-after $B/out/typing-before $B/out/typing-after
...
run before
git checkout -q fix/ENG-2142-nested-components || exit 1
